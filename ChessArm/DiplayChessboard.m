classdef DiplayChessboard < handle
    ...
    methods
        ...
        function AnimateMove(obj)
            ...
            X1 = ((sposx-1)*obj.fieldsize+obj.fieldsize/2);
            Y1 = ((sposy-1)*obj.fieldsize); %-obj.fieldsize/2); 
            
            X2 = ((eposx-1)*obj.fieldsize+obj.fieldsize/2);
            Y2 = ((eposy-1)*obj.fieldsize); %-obj.fieldsize/2); 
            
            deriv = (Y2-Y1)/(X2-X1);
            
            h = animatedline('Parent', obj.viewport, 'MaximumNumPoints',10,'Color','r','LineWidth',3);
            
            %axis('Parent', obj.viewport, [0,10,0,10])
            for j = 1:3
